...
----------------------------------- */
    ...
    table.table thead th {
      background-color: rgba(196, 97, 22, 1);
      color: white;
      border: 1px solid rgba(153, 59, 12, 1);
      text-align: center;
      padding: 0.9px;
...
<body style="background-color: #fffef6ff">
  ...
  <div class="content">
    <div class="container py-4">
      <h1 style="text-align: center; color: #495057; font-weight:bold">Vencer</h1><br>
      ...
      <div class="card shadow-sm mb-4 p-3">
        <div class="row gy-2">
          ...
          <div class="col-md d-flex justify-content-center align-items-center gap-2 flex-wrap">
            <form id="formDescargarExcelVencer" action="../productividad/descargar-excel_vencer.php" method="post" class="m-0">
        ...
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="modalGraficosLabel">Explorador de Gráficos (PENDIENTE, AÚN POR DESARROLLAR)</h5>
            ...
            <div class="modal-body">
              <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card shadow-sm h-100">
                    <div class="card-body">
                      ...
                      <p class="card-text">Gráfico de pastel que muestra el porcentaje de hombres y mujeres según el tipo de evento (Adverso, Quasi falla, Centinela).</p>
                      <button class="btn btn-sm btn-outline-primary">Descargar gráfico</button>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card shadow-sm h-100">
                    <div class="card-body">
                      <h5 class="card-title">Eventos por Año</h5>
                      <p class="card-text">Gráfico de barras que compara la cantidad de eventos registrados por cada año.</p>
                      <button class="btn btn-sm btn-outline-primary">Descargar gráfico</button>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card shadow-sm h-100">
                    <div class="card-body">
                      <h5 class="card-title">Edad acumulada</h5>
                      <p class="card-text">Gráfico de ojiva que representa la distribución acumulada de edad de los pacientes.</p>
                      <button class="btn btn-sm btn-outline-primary">Descargar gráfico</button>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card shadow-sm h-100">
                    <div class="card-body">
                      <h5 class="card-title">Eventos por Servicio</h5>
                      <p class="card-text">Gráfico de barras horizontales que muestra qué servicios hospitalarios reportan más eventos.</p>
                      <button class="btn btn-sm btn-outline-primary">Descargar gráfico</button>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6 col-lg-4">
                  <div class="card shadow-sm h-100">
                    <div class="card-body">
                      ...
                      <p class="card-text">Gráfico de línea que refleja la evolución de eventos mes a mes durante el último año.</p>
                      <button class="btn btn-sm btn-outline-primary">Descargar gráfico</button>
                    </div>
                  </div>
                </div>
